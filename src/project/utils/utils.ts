import {BoxGeometry, Color, Mesh, MeshLambertMaterial, MeshPhongMaterial, Object3D, Vector3} from "three";
...
/**
 * Habilita as sombras num objeto qualquer
 *
 * @param obj
 */
export function enableShadow(obj: Object3D) {
    obj.traverse(obj => {
        if (obj instanceof Mesh) {
            obj.castShadow = true;
            // obj.receiveShadow = true; // TODO: Resolver problema do receive shadow
